...
a for loop is used to print out the contents of the list.  Code with Break commands are contained within each while
loop to exit the loop once the sentinel value has been entered, instead of running the rest of the while loops
